...
local Tabs = {
    ...
    Kitsune = Window:Addtab({ Title = "Kitsune", Icon = "fox"})
    Sea Event  = Window:Addtab({ Title = "Sea Event", Icon = "false"})
}
...
ImageButton.Image= "rbxassetid://16151551893"
...
M:AddToggle({
    Name = "kitsune island positioning",
    Default = false,
    Flag = "EspKitsune",
    Save = true,
    Callback = function(v)
